...
<body>
    ...
    <ul>
        ...
        foreach ($result as $row) {
            printf('<li><span style="color: %s">%s (%s)</span><a href="update.php?id=%s">edit</a><br></br></li><br>',
        ...
        echo '<br><a class="btn btn-default thisBtn" role="button" href="log out.php">Log out</a>';
